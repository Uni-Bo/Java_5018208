public class Main {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee(2, "Alice", "Developer", 60000);
        Employee emp2 = new Employee(4, "Bob", "Manager", 80000);
        ...
        // Delete an employee
        boolean isDeleted = manager.deleteEmployee(4);
        System.out.println("Employee with ID 4 deleted: " + isDeleted);
        ...
        Employee emp4 = new Employee(6, "Diana", "Designer", 55000);
